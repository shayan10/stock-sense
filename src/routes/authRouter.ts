...
router.post('/login', async (req: Request, res: Response) => {
     ...
     try {
          ...
          const {accessToken, refreshToken} = await authController.authenticate(username, password);
...
router.post('/refresh', async (req: Request, res: Response) => {
     try {
          ...
          // Refresh Token
          const {accessToken, refreshToken} = await authController.refresh(req.cookies.refreshToken);
...
router.get("/logout", authMiddleware, async (req: Request, res: Response) => {
     try {
          ...
          authController.logout(req.headers.authorization, req.cookies.refreshToken);
