...
export class TokenService {
    ...
    constructor(private access_token_length:number , private refresh_token_length: number,
        private tokenBlacklist: TokenBlacklist, private JWT_SECRET: string) {}

    private generateToken(userId: string, expiryMin: number, options: object = {}): string {
    ...
    private async verifyToken(type: TokenType, token: string): Promise<string> {
        try {
